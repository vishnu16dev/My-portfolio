...
// OPEN CONTACT FORM
document.querySelector(".secMail").addEventListener("click", function (event) {
...
document
  ...
  .addEventListener("click", function (event) {
    ...
    if (name && email && subject && message) {
      ...
      if (emailValid) {
        ...
        fetch("https://api.emailjs.com/api/v1.0/email/send", {
          ...
          .then((httpResponse) => {
            document
              .querySelector("#contact_form_submit")
              .classList.remove("secMail_active");
            if (httpResponse.ok) {
              if (
                document
                  .querySelector(".contact_form_success")
                  .classList.contains("contact_form_hide")
              ) {
                document
                  .querySelector(".contact_form_success")
                  .classList.remove("contact_form_hide");
                setTimeout(() => {
                  document.querySelector("nav").classList.remove("nav_hidden");
                  document
                    .querySelector("footer")
                    .classList.remove("nav_hidden");
                  document.querySelector("#contactForm").style.opacity = 0;
                  setTimeout(() => {
                    document
                      .querySelector("#contactForm")
                      .classList.add("hidden_layer");
                  }, "500");
                }, "2000");
              }
            } else {
              if (
                document
                  .querySelector(".contact_form_mail_error")
                  .classList.contains("contact_form_hide")
              ) {
                document
                  .querySelector(".contact_form_mail_error")
                ...
                setTimeout(() => {
                  document
                    .querySelector(".contact_form_mail_error")
                    .classList.add("contact_form_hide");
                }, "3000");
              }
            }
          })
        ...
        if (
          document
            .querySelector(".contact_form_mail_inv")
            .classList.contains("contact_form_hide")
        ) {
          document
            .querySelector(".contact_form_mail_inv")
      ...
      if (
        document
          .querySelector(".contact_form_missing")
          .classList.contains("contact_form_hide")
      ) {
        document
          .querySelector(".contact_form_missing")
